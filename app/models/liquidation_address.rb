class LiquidationAddress
  ...
  def save
    ...
    Address.create(postal_code: postal_code, source_id: source_id, city: city, block: block, building_name: building_name,
                   phone_number: phone_number, liquidation_id: liquidation.id)
  end
end
